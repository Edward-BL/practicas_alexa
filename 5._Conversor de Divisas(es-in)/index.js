...
const languageStrings = {
  en: {
    translation: {
      WELCOME_MESSAGE: 'Hello, welcome to your currency converter, here you can make currency conversions, such as pesos to dollars.',
      HELP_MESSAGE: 'How can I help you? try saying *converts dollars to pesos*',
  ...
  es:{
    translation: {
      WELCOME_MESSAGE: 'Hola, bienvenido a tu conversor de divisas, aqui podras realizar conversiones de monedas, como por ejemplo pesos a dolares',
      HELP_MESSAGE: 'En que Puedo aydarte. intenta diciendo *convierte dolares a pesos*',
