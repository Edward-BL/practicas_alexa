...
const languageStrings = {
    en: {
        translation: {
            WELCOME_MESSAGE: 'Welcome to your basic calculator, where you can perform basic operations such as: add, subtract, multiply and divide',
    ...
    es: {
        translation: {
            WELCOME_MESSAGE: 'Bienvenido a tu calculadora basica, en donde podras realizar operaciones basicas como:  sumar, restar, multiplicar y dividir',
            SUMA_MX: 'Suma Español',
            RESTA_MX: 'Resta Español',
            MULTIPLICACION_MX: 'Multiplicacion Español',
            DIVISION_MX: 'Division Español',
            HELP_MESSAGE: 'puedes decir, suma 5 mas 5, resta 3 menos 5, multiplica 5 por 3  o divide 10 entre 2',
