...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hola, puedo darte datos curiosos de algun lenguaje de programacion, solo tienes que mencionarlo, por ejemplo, prueba diciendo "JavaScript"';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Puedo darte datos curiosos de algún lenguaje de programacion, di algo como "Prueba JavaScript"';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Que las buenas practicas te acompañen y que tengas un buen codigo!!';
